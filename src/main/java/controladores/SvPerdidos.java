 ...
 * @author Usuario
 */
@WebServlet(name = "SvPerdidos", urlPatterns = {"/gestionar/perdidos"})
public class SvPerdidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SvPerdidos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SvPerdidos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(Connection connection = dataSource.getConnection()) {
            ...
            if (opt != null && opt.equals("add")) {
                ...
                request.getRequestDispatcher("/jsp/perdidos.jsp").forward(request, response);
