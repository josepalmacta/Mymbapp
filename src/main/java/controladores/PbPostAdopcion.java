 ...
 * @author Usuario
 */
@WebServlet(name = "PbPostAdopcion", urlPatterns = {"/adopcion/*"})
public class PbPostAdopcion extends HttpServlet {
    ...
    private void mostrarPost(String value, String pathInfo, HttpServletRequest request, HttpServletResponse response, Connection connection) throws Exception {
        ...
        getServletConfig().getServletContext().getRequestDispatcher("/vistas/public/postAdopcion.jsp").forward(request, response);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pathInfo == null) {
            getServletConfig().getServletContext().getRequestDispatcher("/vistas/public/buscarAdopcion.jsp").forward(request, response);
            return;
        }
            ...
            if (action.equals("post")) {
                ...
                if (!value.equals("vistas")) {
                    ...
                    if (value.equals("add")) {
                        ...
                        getServletConfig().getServletContext().getRequestDispatcher("/vistas/public/postAdopciones.jsp").forward(request, response);
                        return;
                    } else if (esNum(value)) {
                        if (pathParts.length > 3 && pathParts[3].equals("edit")) {
                            ...
                            request.setAttribute("dets", post.listarID());
                            getServletConfig().getServletContext().getRequestDispatcher("/vistas/public/editAdopcion.jsp").forward(request, response);
                            return;
                        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            if (action.equals("add")) {
                ...
                post.setEstado("ADOPCION");
                post.setRequisitos(obj.getString("info"));
                ...
                post.setRequisitos(request.getParameter("requisitos"));
