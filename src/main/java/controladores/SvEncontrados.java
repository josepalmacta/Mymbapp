 ...
 * @author Usuario
 */
@WebServlet(name = "SvEncontrados", urlPatterns = {"/gestionar/encontrados"})
public class SvEncontrados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SvEncontrados</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SvEncontrados at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(Connection connection = dataSource.getConnection()) {
            ...
            if (opt != null && opt.equals("del")) {
                ...
                request.getRequestDispatcher("/jsp/encontrados.jsp").forward(request, response);
