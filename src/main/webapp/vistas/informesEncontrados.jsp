    ...
    <div class="pb-20">
        ...
        <div class="tab">
            <ul class="nav nav-tabs customtab mb-20" role="tablist">                
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#encontrados" role="tab" aria-selected="true">Informe General</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#encontradosdet" role="tab" aria-selected="false">Informe Detallado</a>
                </li>              
            </ul>
            <div class="tab-content">

                <div class="tab-pane fade show active" id="encontrados" role="tabpanel">
                    <div class="pd-20">
                        <div class="clearfix">
                            <div class="d-flex">
                                <div class="d-block">
