<%-- 
    Document   : especies
    Created on : 4 jun 2024, 13:43:27
    Author     : Usuario
--%>
...
<div class="modal fade" id="form-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                <h4 class="padding-top-30 mb-30 weight-500">ESPECIE</h4>
                <form>
...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">GESTIONAR ESPECIES</h4>
        </div>
    </div>
</div>
...
<div class="card-box mb-30">
    <div class="pd-20 d-flex">
        ...
        <a type="button" class="btn btn-primary" style="margin-left: 15px;" target="_blank" href="/reporte.jsp?reporte=especies"><i class="fa-regular fa-file"></i> REPORTE</a>
    </div>
    <div class="pb-20">
...
<script type="text/javascript">
    ...
    function sendData() {
        ...
        $.ajax(
                {
                    data: {opt: opt, nombre: nombre, codigo: codigo},
                    url: "/gestionar/especies",
                    type: "post",
                    success: function (response) {
                        let res = JSON.parse(response);
