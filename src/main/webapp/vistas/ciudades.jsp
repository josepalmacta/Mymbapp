...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">GESTIONAR CIUDADES</h4>
        </div>
    </div>
</div>
...
<div class="card-box mb-30">
    <div class="pd-20 d-flex">
        ...
        <a type="button" class="btn btn-primary" style="margin-left: 15px;" target="_blank" href="/reporte.jsp?reporte=ciudades"><i class="fa-regular fa-file"></i> REPORTE</a>
    </div>
    <div class="pb-20">
...
<script type="text/javascript">
    ...
    function transferir(id, nombre, apellido, depar) {
        $("#codigo").val(id);
        $("#nombre").val(nombre);
        $("#code").val(apellido);
    ...
    function sendData() {
        ...
        $.ajax(
                {
                    data: {opt: opt, nombre: nombre, code: code, codigo: codigo, departamento: departamento},
                    url: "/gestionar/ciudades",
                    type: "post",
                    success: function (response) {
                        let res = JSON.parse(response);
