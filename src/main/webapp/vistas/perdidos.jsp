<%-- 
    Document   : perdidos
    Created on : 15 jul 2024, 23:08:44
    Author     : Usuario
--%>
...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">GESTIONAR PUBLICACIONES DE MASCOTAS PERDIDAS</h4>
        </div>
    </div>
</div>
...
<div class="card-box mb-30">  
    <div class="py-3">
        ...
        <a type="button" class="btn btn-primary" style="margin-left: 15px;" target="_blank" href="/reporte.jsp?reporte=publicaciones"><i class="fa-regular fa-file"></i> REPORTE</a>
    </div>
    <div class="pb-20">
