<%-- 
    Document   : postAdopciones
    Created on : 25 jul 2024, 10:46:48
    Author     : Usuario
--%>
...
<% String titulo = "Crear Publicacion de Adopcion"; %>
    ...
    <div id="contenid">
        ...
        <div class="p-3">
            <div class="d-flex gap-1 align-items-center pt-3">
                <h3 class="fw-bold text-dark mb-0">PUBLICAR MASCOTA EN ADOPCION</h3>
            </div>
        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="plugar" role="tabpanel">
                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-3 text-center">
                            <h4>¿En que barrio se encuentra?</h4>
                        </div>
                ...
                <div class="tab-pane fade" id="pubicacion" role="tabpanel">
                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-3 text-center">
                            <h4>Ubique la zona en el mapa</h4>
                        </div>
                ...
                <div class="tab-pane fade" id="pinfo" role="tabpanel">
                    ...
                    <div class="p-3">
                        <div class="mb-1 mt-5">
                            ...
                            <div class="input-group flex-nowrap">
                                <textarea maxlength="200" rows="4" id="descripcion" name="descripcion" class="form-control px-3 py-2"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-5 mt-5">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input id="contacto" class="form-control" type="text" placeholder="098Xxxxxxx">
                            </div>
                        </div>
