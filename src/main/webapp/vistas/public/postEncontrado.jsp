<%-- 
    ...
    Created on : 24 jul 2024, 11:02:23
    Author     : Usuario
--%>
...
<%
         ...
         String titulo = "Mascota Encontrada en " + obj.getString("lugar");
    ...
    <div class="p-3">
        <div class="p-4">
            <div class="dbkfx align-items-center">
                ...
                <% } %>
                <h1 class="card-title mb-0 fw-semibold">Mascota Encontrada <small class="small fs-2 fw-normal">en <% out.println(obj.getString("lugar")); %></small></h1>
            </div>
        </div>
                                ...
                                for (int j = 0; j < masco.getJsonArray("imgs").size(); j++) {
                                    ...
                                    act = " active";
                                        ...
                                        <div class="carousel-item<%out.print(act);%>">
                                            <img class="carr-img" src="/imgs/posts/e/<% out.print(masco.getJsonArray("imgs").getString(j)); %>" class="d-block w-100" alt="...">
                                        </div>
