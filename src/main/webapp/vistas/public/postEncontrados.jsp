<%-- 
    Document   : postEncontrados
    Created on : 24 jul 2024, 11:06:26
    Author     : Usuario
--%>
...
<% String titulo = "Crear Publicacion Mascota encontrada"; %>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="AgregarModalLabel">DETALLES DE LA MASCOTA ENCONTRADA</h1>
    ...
    <div id="contenid">
        ...
        <div class="p-3">
            <div class="d-flex gap-1 align-items-center pt-3">
                <h3 class="fw-bold text-dark mb-0">REPORTAR MASCOTA ENCONTRADA</h3>
            </div>
        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="plugar" role="tabpanel">
                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-3 text-center">
                            <h4>¿En que barrio fue encontrado?</h4>
                        </div>
                ...
                <div class="tab-pane fade" id="pubicacion" role="tabpanel">
                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-3 text-center">
                            <h4>Ubique la zona en la que se encontro.</h4>
                        </div>
                        ...
                        <div class="mb-1 mt-5">
                            ...
                            <div class="input-group flex-nowrap">
                                <textarea maxlength="200" rows="4" id="descripcion" name="descripcion" class="form-control px-3 py-2"
                                          placeholder="Ingrese aqui cualquier otra informacion util sobre la mascota encontrada."></textarea>
                            </div>
                        </div>
