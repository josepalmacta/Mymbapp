...
<div class="contain">
    <div id="mensajeconf" class="text-center d-none">
        ...
        <a href="/encontrados/post/<% out.print(obj.getString("postid")); %>" class="btn btn-warning border-radius-100 btn-block confirmation-btn mt-2 text-primary"><i class="fa-solid fa-file-invoice me-2 text-primary"></i> Ver publicacion</a>
    </div>
    <div id="contenid">
        <div class="p-3">
            ...
            <div class="mb-3 mt-5">
                <h6>¿Ya localizaste al dueño de la mascota?</h6>
                <h7>Si ya te contactaste al dueño de la mascota por favor haz clic en el boton para actualizar el estado de la publicacion a "DEVUELTO"</h7>
                <div class="input-group flex-nowrap p-3">
                    <button onclick="mostrarConfirm()" class="btn btn-primary"><i class="fa-solid fa-check"></i> Mascota devuelta</button>
                </div>
            ...
            <div class="mb-3 mt-5">
                <label class="form-label">ZONA EN DONDE SE ENCONTRO</label>
                <div class="input-group flex-nowrap">
...
<script>
    ...
    function mostrarConfirm() {
        swal(
                {
                    type: "warning",
                    text: 'Si actualiza el estado a "DEVUELTO" se dara por finalizada la publicacion.',
                    position: 'center',
