<%-- 
    Document   : buscarEncontrados
    Created on : 24 jul 2024, 17:27:42
    Author     : Usuario
--%>
...
<% String titulo = "Mascotas Encontradas"; %>
    ...
    <div class="p-3">
        ...
        <div id="resultads" class="row row-cols-2 row-cols-sm-2 row-cols-md-2 g-3 py-5">
            <%
                    ...
                    modelos.postEncontrados posts = new modelos.postEncontrados(connection);
         ...
         for (int i = 0; i < arr.size(); i++) {
            ...
            <div class="col lostlist">
                <div class="card border-0 rounded-3 shadow overflow-hidden overflow-hidden">
                    <div class="card-header text-body-secondary"><i class="fa-regular fa-calendar-days me-1"></i> <% if(obj.getString("fecha").equals("0")){out.print("Hoy");}else if(obj.getString("fecha").equals("1")){out.print("Ayer");}else{out.print("Hace " + obj.getString("fecha") + " dias");} %></div>
                    <% if(obj.getString("estado").equals("LOCALIZADO")){ %>
                    <div class="badge badgeenc bg-success">LOCALIZADO</div>
                    <% } %>
                    <div class="card-body">
                        <img src="/imgs/posts/e/<% out.print(obj.getString("img")); %>" class="position-relative">
                    </div>
