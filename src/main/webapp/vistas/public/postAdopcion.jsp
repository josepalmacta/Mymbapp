<%-- 
    Document   : postAdopcion
    Created on : 25 jul 2024, 10:50:43
    Author     : Usuario
--%>
...
<%
         ...
         String titulo = "Mascota en Adopcion en " + obj.getString("lugar");
    ...
    <div class="p-3">
        <div class="p-4">
            <div class="dbkfx align-items-center">
                <% if(obj.getString("p_estado").equals("ADOPTADO")){ %>
                <div class="badge bg-danger p-2 me-3"><span class="fs-5"><i class="fa-regular fa-heart"></i> ADOPTADO</span></div>
                <% } %>
                <h1 class="card-title mb-0 fw-semibold">Mascota en Adopcion <small class="small fs-2 fw-normal">en <% out.println(obj.getString("lugar")); %></small></h1>
            </div>
        </div>
                    ...
                    <div class="rounded-4 shadow p-3 mb-4">
                        <div class="card-body">
                            <div class="overflow-hidden rounded-3 mb-4">
                                ...
                                for (int j = 0; j < masco.getJsonArray("imgs").size(); j++) {
                                        ...
                                        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="<%out.print(contad);%>"
                                                <% if(contad == 0){ %> class="active" aria-current="true" <% } %> aria-label=""></button>
                                       <% contad++; }}%>
                                    </div>
                            ...
                            <div class="carousel-item<%out.print(act);%>">
                                            <img class="carr-img" src="/imgs/posts/a/<% out.print(masco.getJsonArray("imgs").getString(j)); %>" class="d-block w-100" alt="...">
                                        </div>
