...
<tr>
    ...
    <td><% out.print(obj.getString("dep")); %></td>
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                <button class="dropdown-item" onclick="transferir('<% out.print(obj.getString("id")); %>', '<% out.print(obj.getString("nombre")); %>', '<% out.print(obj.getString("codigo")); %>', '<% out.print(obj.getString("departamento")); %>')" data-toggle="modal" data-target="#form-modal"><i class="fa-solid fa-pen-to-square"></i> MODIFICAR</button>
                ...
                <a target="_blank" href="/reporte.jsp?reporte=ciudad&codigo=<% out.print(obj.getString("id")); %>" class="dropdown-item"><i class="fa-regular fa-file"></i> REPORTE</a>
            </div>
        </div>
    </td>
</tr>
