<%-- 
    Document   : perdidos
    Created on : 15 jul 2024, 23:29:42
    Author     : Usuario
--%>
    ...
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                ...
                <a target="_blank" href="/reporte.jsp?reporte=publicacion&codigo=<% out.print(obj.getString("id")); %>" class="dropdown-item"><i class="fa-regular fa-file"></i> REPORTE</a>
            </div>
        </div>
    </td>
</tr>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">                
                ...
                <p class="lead"><b>Recompensa: </b><span><% out.print(obj.getString("recompensa"));%></span></p>
