<%-- 
    Document   : especies
    Created on : 4 jun 2024, 13:47:33
    Author     : Usuario
--%>
    ...
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                <button class="dropdown-item" onclick="transferir('<% out.print(obj.getString("id")); %>', '<% out.print(obj.getString("nombre")); %>')" data-toggle="modal" data-target="#form-modal"><i class="fa-solid fa-pen-to-square"></i> MODIFICAR</button>
                ...
                <a target="_blank" href="/reporte.jsp?reporte=especie&codigo=<% out.print(obj.getString("id")); %>" class="dropdown-item"><i class="fa-regular fa-file"></i> REPORTE</a>
            </div>
        </div>
    </td>
</tr>
