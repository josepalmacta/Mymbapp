<%-- 
    Document   : adopciones
    Created on : 27 sept 2024, 21:36:29
    Author     : Usuario
--%>
    ...
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                ...
                <a target="_blank" href="/reporte.jsp?reporte=adopcion&codigo=<% out.print(obj.getString("id")); %>" class="dropdown-item"><i class="fa-regular fa-file"></i> REPORTE</a>
            </div>
        </div>
    </td>
</tr>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">                
                ...
                <p class="lead"><b>Requisitos:</b><br><span><% out.print(obj.getString("info"));%></span></p>
            </div>
